...
Download a fresh Kali VM from [here](https://www.kali.org/get-kali/#kali-virtual-machines), create a VM in VirtualBox or VMware and change from NAT to Bridge. Now run the following commands to set up the Kali VM.
